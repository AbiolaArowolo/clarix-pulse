...
export function InstallWorkspacePanel() {
  ...
  return (
    <section className="ui-shell-panel rounded-[var(--radius-panel)] px-5 py-5 sm:px-6 sm:py-6">
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1.15fr)_minmax(260px,0.85fr)] xl:items-start">
        <div className="min-w-0">
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              <h3 className="mt-3 text-2xl font-semibold text-slate-50 sm:text-3xl">Keep this workspace close on desktop and mobile.</h3>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <button
              ...
              className="rounded-[var(--radius-control)] border border-slate-700 bg-slate-900/75 px-4 py-2.5 text-sm font-medium text-slate-100 transition-colors hover:border-slate-500 hover:text-white xl:hidden"
            >
              {showQr ? 'Hide QR' : 'Show QR'}
            </button>
          </div>

          <div className="mt-6 rounded-[var(--radius-panel)] border border-slate-800/70 bg-slate-950/45 p-5">
        ...
        <div className={`${showQr ? 'block' : 'hidden'} xl:block`}>
