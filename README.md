...
- Customer guide (print/PDF): [docs/CUSTOMER_GUIDE_PRINT.html](docs/CUSTOMER_GUIDE_PRINT.html)
- Quick start: [docs/QUICK_START.md](docs/QUICK_START.md)
- Hub manual: [docs/HUB_MANUAL.md](docs/HUB_MANUAL.md)
- Node manual: [docs/NODE_MANUAL.md](docs/NODE_MANUAL.md)
